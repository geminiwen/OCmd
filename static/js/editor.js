...
(function() {
    ...
    if (typeof document.cancelFullScreen != 'undefined' || require) {
...
(function () {
    ...
    function mainHandler(data) {
        if (data) {
            ...
            $('#wmd-help-button').css('margin-left', '20px');
            $('#wmd-editor-full-button').css('margin-left', '30px');
            $('#wmd-editor-small-button').css('margin-left', '30px');
